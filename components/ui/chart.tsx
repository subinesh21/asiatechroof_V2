            ...
            return (
              ...
              >
                {formatter && itemTyped?.value !== undefined && itemTyped.name ? (
                  formatter(itemTyped.value, itemTyped.name, item, index, item.payload)
                ) : (
                  <>
                    {itemConfig?.icon ? (
                      <itemConfig.icon />
                    ...
                    >
                      <div className="grid gap-1.5">
                        {nestLabel ? tooltipLabel : null}
                        <span className="text-muted-foreground">{itemConfig?.label || (itemTyped.name as React.ReactNode)}</span>
                      </div>
                      {itemTyped.value && (
